...
import com.example.oujunlong.wanandroid2.utils.StatusBarUtil;
...
public class ScrollingActivity extends BaseActivity {
    ...
    com.scwang.smartrefresh.header.flyrefresh.MountanScenceView mAboutUsMountain;
...
//            }
    ...
    private void showAboutContent() {
        ...
        try {
            String versionStr = getString(R.string.wanAndroid)
