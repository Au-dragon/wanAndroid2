 ...
 * author oujunlong
 */
public class WxRvAdapter extends RecyclerView.Adapter {
    private ArrayList<WxDateBean.DataBean.DatasBean> list;
    private Context context;
    private OnItemClickListener mOnItemClickListener;

    public WxRvAdapter(ArrayList<WxDateBean.DataBean.DatasBean> list, Context context) {
        this.list = list;
        this.context = context;
    }

    public void setList(ArrayList<WxDateBean.DataBean.DatasBean> list) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if(list.get(i).isFresh()){
            myViewHolder.t5.setVisibility(View.VISIBLE);
        }else {
            myViewHolder.t5.setVisibility(View.GONE);
        }
